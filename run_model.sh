...
: "${MODEL_ID:=YukinoStuki/Qwen2.5-0.5B-Plus-LLM}"
...
export BATCH_MODE BATCH_CONCURRENCY VLLM_BATCH_USE_LLM TEMPERATURE TOP_P TOP_K GPU_MEMORY_UTILIZATION DTYPE TRANSFORMERS_DTYPE
...
export ENABLE_PREFIX_CACHING VLLM_QUANTIZATION VLLM_KV_CACHE_DTYPE VLLM_LOAD_FORMAT
...
: "${WARMUP_NUM_SAMPLES:=7000}"
: "${WARMUP_NUM_SAMPLES_CAP:=7000}"
: "${WARMUP_REPEAT:=2}"
export WARMUP_DATA_PATH WARMUP_NUM_SAMPLES WARMUP_NUM_SAMPLES_CAP WARMUP_REPEAT
